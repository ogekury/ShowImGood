...
<div class="col-md-8 col-md-offset-2">
    ...
    <div class="comment" ng-hide="loading" ng-repeat="comment in comments">
        ...
        <p class="box off" ng-hide="toggle" ng-animate="'box'">
            <input type="text" value="{{comment.text}}" ng-value="{{commentupd}}" ng-model="comment.commentupd"/>
            <input type="button" value="Update" ng-click="updateComment(comment.id,comment.commentupd)"/>
        </p>
